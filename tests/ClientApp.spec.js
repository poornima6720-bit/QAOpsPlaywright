...
test.skip('Page Playwright Test', async ({page})=>{
    ...
    // const cartCount= await cartInfo.count();
    // for(let i=0; i<cartCount; i++)
    // {
    //     const cartProductName= await cartInfo.nth(i).locator('h3').textContent();
    ...
    //const tableBody= page.locator('.table-bordered tbody');
